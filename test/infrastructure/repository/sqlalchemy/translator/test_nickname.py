...
from src.domain.model.nickname import NicknameChangelog as DomainNicknameChangelog
...
from src.infrastructure.repository.sqlalchemy.translator.nickname import (
